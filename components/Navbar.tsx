...
/** Satyasri Realtors building/skyline icon — orange, matches brand brief */
function SatyasriLogoIcon({ size = 36 }: { size?: number }) {
  return (
    ...
    >
      ...
      <rect width="40" height="40" rx="9" fill="#e8541e" />
      {/* Building skyline — white icon on orange */}
      {/* Left short building */}
      <rect x="5" y="20" width="7" height="14" rx="1" fill="white" opacity="0.9" />
      {/* Left building window */}
      <rect x="7" y="23" width="3" height="3" rx="0.5" fill="#e8541e" />
      {/* Centre tall building */}
      <rect x="14" y="12" width="12" height="22" rx="1" fill="white" />
      {/* Centre building windows */}
      <rect x="16.5" y="15" width="3" height="3" rx="0.5" fill="#e8541e" />
      <rect x="21" y="15" width="3" height="3" rx="0.5" fill="#e8541e" />
      <rect x="16.5" y="21" width="3" height="3" rx="0.5" fill="#e8541e" />
      <rect x="21" y="21" width="3" height="3" rx="0.5" fill="#e8541e" />
      ...
      <rect x="30" y="20" width="3" height="3" rx="0.5" fill="#e8541e" />
      {/* Ground line */}
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="/" className="flex items-center gap-2.5 shrink-0">
            ...
            <div className="leading-tight">
              ...
              >
                Satyasri
                <span className="text-[#e8541e]"> Realtors</span>
              </span>
              <span
          ...
          <nav className="container py-4 flex flex-col gap-1">
            {navLinks.map((link) => (
              <Link
                ...
                className="px-4 py-3 rounded-lg text-[#1a1a1a] font-medium hover:bg-[#f8f7f4] hover:text-[#e8541e] transition-colors"
              >
                {link.label}
              </Link>
            ))}
